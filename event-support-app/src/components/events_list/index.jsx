...
getAllMembers() {
 this.setState({
   events: ["wydarzenie1","wydarzenie2","wydarzenie3","wydarzenie4","wydarzenie5","wydarzenie6","wydarzenie7","wydarzenie8","wydarzenie9"]
 })
}
...
renderEvents = (event, index) => {
  return (
    ...
    <Card.Body>
      ...
      <Card.Text>
        OPISIKk example text to build on the card title and make up the bulk of
        the card's content. + {event}
      </Card.Text>
